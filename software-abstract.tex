...
example of a minimal session using our code\footnote{A longer one is available
  at
...
\textcolor{red}{In:}  p = 5
     \textcolor{gray}{# We create k2 = F_5(x2) = F_25}
...
\textcolor{red}{In:}  \textcolor{gray}{# We can directly call k8 } 
     z = k8(x4^2+1)
